    //while(theres still numbers)
        //for(through the arr)
        //if (isNan(arr[i] && next num is a number && next  next num is a number){
            //do the operation
            //reaplce three values in a rr with the result
            //}
